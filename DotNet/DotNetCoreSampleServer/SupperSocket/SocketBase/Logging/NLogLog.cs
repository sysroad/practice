...
namespace SuperSocket.SocketBase.Logging
{
    public class NLogLog : ILog
    {
        ...
        {
            Log.Error($"msg:{message}, exception:{exception}");
        }
        ...
        {
            Log.Fatal($"msg:{message}, exception:{exception}");
        }
        ...
        {
            Log.Info($"msg:{message}, exception:{exception}");
        }
        ...
        {
            Log.Warn($"msg:{message}, exception:{exception}");
        }
