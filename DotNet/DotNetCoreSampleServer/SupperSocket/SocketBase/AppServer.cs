...
namespace SuperSocket.SocketBase
{
        ...
        where TAppSession : AppSession<TAppSession, TRequestInfo>, IAppSession, new()
    {
        ...
        protected override void OnSessionClosed(TAppSession session, CloseReason reason)
        {
            ...
            if (!string.IsNullOrEmpty(sessionID))
            {
                if (!m_SessionDict.TryRemove(sessionID, out _))
                {
                    if (Logger.IsErrorEnabled)
        ...
        private void StartCollectSendSessionTimer()
        {
            ...
            CollectSendSessionTimer = new System.Threading.Timer(CollectSendSession, new object(), interval, interval);
        ...
        public Timer CollectSendSessionTimer { get; set; } = null;
